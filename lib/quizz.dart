...
class Quizz extends StatelessWidget {
  static final questions = [
    ...
    },
    {
      ...
      'answer': [
        {
          'yourAnswer': 'close 150',
          'score': [0]
        },
        {
          'yourAnswer': 'close to 170',
          'score': [10]
        },
        {
          'yourAnswer': 'close to 190',
          'score': [20]
        },
        {
          'yourAnswer': 'close to 200',
          'score': [15]
        }
      ]
    }
  ...
  int indexA;
  final Function nextPageAndScoreA;
  Quizz({
    ...
    return Column(
      children: [
        ...
        ...(questions[indexA]['answer'] as List<Map<String, Object>>)
            .map((question) {
          return Answers(
              nextPageAndScoreB: nextPageAndScoreA,
